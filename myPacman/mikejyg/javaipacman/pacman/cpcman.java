...
implements Runnable, KeyListener, ActionListener, WindowListener
{
    ...
    // for graphics
    final int canvasWidth=1840;
    final int canvasHeight=1035;
    ...
    public void initImages()
    {
        ...
        theFlag = new cflag(this, offScreenG);
        // initialize pac object
        //          pac = new cpac(this, offScreenG, maze, powerDot, ghosts);
        pac = new cpac(this, offScreenG, maze, powerDot, theFlag);
    ...
    void paintUpdate(Graphics g)
    {
        ...
        //         g.setStroke(new BasicStroke(1000));
        //         g.setColor(Color.BLACK);
        //         g.drawOval(pac.iX-300,pac.iY-300,700,700);
    ...
    void move()
    {
        ...
        {
            scoreGhost=200;
            boolean eaten = powerDot.allEaten();
            if (eaten)
            {
                maze.newPowerDots(powerDot);
            }
        }
        ...
        if(pac.hasFlag() && pac.iX >= 1050 && pac.iY >= 535){
            dispose();
